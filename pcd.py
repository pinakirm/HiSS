        ...
        for x in train_loader:
            ...
            for k in range(args.sampling_steps):
                if sampler.entropy==False:
                    ...
                    sample_tuple=sampler.step(buffer.detach(), buffer_a.detach(), model)
                    buffer = sample_tuple[0].detach()
                    buffer_a = sample_tuple[1].detach()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_file', type=str, default='./DATASETS/ising_dim_25_sigma_.25/data.pkl', help="location of pkl containing data")
    ...
    parser.add_argument('--sigma', type=float, default=.25)  # ising and potts
